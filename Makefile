...
classloader:
	...
	@docker exec -it docker_camac_web_1 php -c /var/local/tools/zend/php_cli.ini /usr/src/tools/zend/classmap_generator.php -w -l  /var/www/html/library/ -o /var/www/html/library/class_map.php
