...
class Workflow_InstanceResource_Workflow_Helper_InstanceResourceWorkflow extends Zend_Controller_Action_Helper_Abstract implements Camac_InstanceResource_Helper_Interface {
	...
	public function getForm() {
		return new Workflow_InstanceResource_Workflow_Form();
	}
