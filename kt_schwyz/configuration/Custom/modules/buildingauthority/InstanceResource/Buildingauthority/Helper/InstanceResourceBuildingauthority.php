...
class Buildingauthority_InstanceResource_Buildingauthority_Helper_InstanceResourceBuildingauthority extends Zend_Controller_Action_Helper_Abstract implements Camac_InstanceResource_Helper_Interface {
	...
	public function getForm() {
		return new Buildingauthority_InstanceResource_Buildingauthority_Form();
	}
	...
	/**
	 * Retrieves the url of the file with the context menu fo the additional tabs.
	 *
	 * @return null
	 */
