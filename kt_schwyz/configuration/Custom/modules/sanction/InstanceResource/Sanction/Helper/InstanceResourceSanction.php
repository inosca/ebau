...
class Sanction_InstanceResource_Sanction_Helper_InstanceResourceSanction extends Zend_Controller_Action_Helper_Abstract implements Camac_InstanceResource_Helper_Interface {
	...
	public function getForm() {
		return new Sanction_InstanceResource_Sanction_Form();
	}
