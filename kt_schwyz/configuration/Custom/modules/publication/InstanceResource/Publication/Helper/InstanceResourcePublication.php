...
class Publication_InstanceResource_Publication_Helper_InstanceResourcePublication extends Zend_Controller_Action_Helper_Abstract implements Camac_InstanceResource_Helper_Interface {
	...
	public function getForm() {
		return new Publication_InstanceResource_Publication_Form();
	}
