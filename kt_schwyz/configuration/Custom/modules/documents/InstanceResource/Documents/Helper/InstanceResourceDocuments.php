...
class Documents_InstanceResource_Documents_Helper_InstanceResourceDocuments extends Zend_Controller_Action_Helper_Abstract implements Camac_InstanceResource_Helper_Interface {
	...
	public function getForm() {
		return new Documents_InstanceResource_Documents_Form();
	}
