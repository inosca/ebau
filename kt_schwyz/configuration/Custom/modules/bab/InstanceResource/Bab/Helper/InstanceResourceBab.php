...
class Bab_InstanceResource_Bab_Helper_InstanceResourceBab extends Zend_Controller_Action_Helper_Abstract implements Camac_InstanceResource_Helper_Interface {
	...
	public function getForm() {
		return new Bab_InstanceResource_Bab_Form();
	}
