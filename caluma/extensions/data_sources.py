...
class Municipalities(BaseDataSource):
    ...
    def get_data(self, info):
        return [
            [2, "Burgdorf"],
            [20003, "Eggiwil"],
            [20005, "Hasle bei Burgdorf"],
            [20007, "Langnau im Emmental"],
            [20009, "Lyssach"],
            [20011, "Oberburg"],
            [20013, "Rüderswil"],
            [20017, "Trubschachen"],
            ...
            [20285, "Lützelflüh"],
            [20287, "Mötschwil"],
            [20289, "Röthenbach im Emmental"],
            [20293, "Rüegsau"],
            [20295, "Rumendingen"],
            [20297, "Rüti bei Lyssach"],
            [20299, "Schangnau"],
            [20301, "Signau"],
            [20303, "Sumiswald"],
            [20305, "Trachselwald"],
            [20307, "Trub"],
            [20309, "Wiler bei Utzenstorf"],
            [20311, "Willadingen"],
            [20313, "Zielebach"],
            [20315, "Aarwangen"],
            [20317, "Attiswil"],
            ...
            [20325, "Bettenhausen"],
            [20327, "Bleienbach"],
            [20329, "Busswil bei Melchnau"],
            [20331, "Eriswil"],
            [20333, "Farnern"],
            [20335, "Gondiswil"],
            [20337, "Graben"],
            [20339, "Heimenhausen"],
            [20341, "Herzogenbuchsee"],
            [20343, "Huttwil"],
            [20345, "Inkwil"],
            [20347, "Langenthal"],
            [20349, "Lotzwil"],
            ...
            [20369, "Roggwil (BE)"],
            [20371, "Rohrbach"],
            [20373, "Rohrbachgraben"],
            [20375, "Rumisberg"],
            [20377, "Rütschelen"],
            [20379, "Schwarzhäusern"],
            [20381, "Seeberg"],
            [20383, "Thörigen"],
            [20385, "Thunstetten"],
            [20387, "Ursenbach"],
            [20389, "Walliswil bei Niederbipp"],
            [20391, "Walliswil bei Wangen"],
            [20393, "Walterswil (BE)"],
            [20395, "Wangen an der Aare"],
            [20397, "Wangenried"],
            [20291, "Rüdtligen-Alchenflüh"],
            [20399, "Wiedlisbach"],
            [20401, "Wolfisberg"],
            [20403, "Wynau"],
            [20405, "Wyssachen"],
