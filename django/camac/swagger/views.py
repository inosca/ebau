...
GET_TABLE_DATA = [
    ...
    [
        ...
        "5.1",
        ECH_TASK,
        f"[task]({static('xml/get/task.xml')})",
    ],
    [
        "StatusNotification",
    ...
    [
        ...
        "4.1",
        ECH_STATUS_NOTIFICATION_SB2_AUSSTEHEND,
        f"[status_notification_sebstdeklaration_2_ausstehend]({static('xml/get/status_notification_sebstdeklaration_2_ausstehend.xml')})",
    ],
    [
        "StatusNotification",
