...
def test_document_merge_service_cover_sheet_with_header_values(
    ...
    assert {k: v for k, v in client.merge.call_args[0][0].items() if "Header" in k} == {
        ...
        "municipalityHeader": service_t.city,
        "tagHeader": "some tag",
        "authorityHeader": instance_service.service.get_name(),
