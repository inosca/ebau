...
| Inquiry re-invite            | None                                                             | If the inquiry decision is not "Unterlagenergänzung",<br>Create a claim suspension between<br>previous inquiry close till new inquiry.<br>Close all claim suspensions   | Default                                                          |
