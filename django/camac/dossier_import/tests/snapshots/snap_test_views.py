...
snapshots['test_validation_errors[import-example-validation-errors.zip-kt_schwyz-None-400-Gemeinde] 1'] = {
    'errors': [
        {
            'code': 'invalid',
...
snapshots['test_validation_errors[import-example-validation-errors.zip-kt_schwyz-None-400-municipality-lead] 1'] = {
    'errors': [
        {
            'code': 'invalid',
            'detail': 'Kein Standort gesetzt.',
