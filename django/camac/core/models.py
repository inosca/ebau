...
class Attachment(models.Model):
    ...
    attachment_section = models.ForeignKey(
        ...
        db_column='ATTACHMENT_SECTION_ID', related_name='+', blank=True,
        null=True)
    service = models.ForeignKey('Service', models.DO_NOTHING,
                                db_column='SERVICE_ID', related_name='+',
                                blank=True, null=True)
    is_parcel_picture = models.FloatField(
        db_column='IS_PARCEL_PICTURE', blank=True, null=True, default=0)
    digital_signature = models.FloatField(
...
class AttachmentSectionRole(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('attachment_section', 'role_id'),)
