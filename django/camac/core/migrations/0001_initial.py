    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.CharField(db_column='ANSWER', max_length=4000)),
                ('chapter', models.ForeignKey(db_column='CHAPTER_ID', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.QuestionChapter')),
                ('form', models.ForeignKey(db_column='FORM_ID', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.Form')),
                ('question', models.ForeignKey(db_column='QUESTION_ID', on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.QuestionChapter')),
        ...
        migrations.CreateModel(
            name='FormGroupForm',
            fields=[
                ('form_group', models.OneToOneField(db_column='FORM_GROUP_ID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='forms', serialize=False, to='core.FormGroup')),
            ],
            options={
