# Gemeindeschnittstelle eBau Aargau
...
- Auf den "group" Parameter kann verzichtet werden, da im Kt. AG keine dedizierte "Baukontrolle"-Rolle existiert
- Dokumente werden über `ech/v1/files` hoch/runtergeladen (statt über `api/v1/attachments`), da im Kt. AG ein modernisiertes Dokumentenmodul eingesetzt wird
