...
rejected = django.dispatch.Signal()
rejection_reverted = django.dispatch.Signal()
construction_monitoring_started = django.dispatch.Signal()
withdrawn = django.dispatch.Signal()
