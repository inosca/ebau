# ../../camac/ech0211/schema/ech_0097_2_0.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:c77de26c97dd629e89fd332613ef2b4ab3ec9785
# Generated 2022-03-31 09:05:47.006679 by PyXB version 1.2.6 using Python 3.8.12.final.0
...
class organisationIdCategoryType (pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 5, 1)
    _Documentation = None
...
class STD_ANON (pyxb.binding.datatypes.token):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 31, 4)
    _Documentation = None
...
class uidOrganisationIdCategorieType (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 46, 1)
    _Documentation = None
uidOrganisationIdCategorieType._CF_enumeration = pyxb.binding.facets.CF_enumeration(enum_prefix=None, value_datatype=uidOrganisationIdCategorieType)
...
uidOrganisationIdCategorieType._InitializeFacetMap(uidOrganisationIdCategorieType._CF_enumeration,
...
class uidOrganisationIdType (pyxb.binding.datatypes.nonNegativeInteger):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 54, 1)
    _Documentation = None
...
uidOrganisationIdType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value=pyxb.binding.datatypes.nonNegativeInteger(999999999), value_datatype=uidOrganisationIdType)
uidOrganisationIdType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value=pyxb.binding.datatypes.nonNegativeInteger(1), value_datatype=uidOrganisationIdType)
uidOrganisationIdType._CF_totalDigits = pyxb.binding.facets.CF_totalDigits(value=pyxb.binding.datatypes.positiveInteger(9))
uidOrganisationIdType._InitializeFacetMap(uidOrganisationIdType._CF_fractionDigits,
...
class organisationNameType (pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 62, 1)
    _Documentation = None
...
organisationNameType._InitializeFacetMap(organisationNameType._CF_maxLength,
   organisationNameType._CF_minLength)
...
class legalFormType (pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 68, 1)
    _Documentation = None
...
legalFormType._InitializeFacetMap(legalFormType._CF_maxLength,
   legalFormType._CF_minLength,
...
class STD_ANON_ (organisationIdCategoryType):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 24, 4)
    _Documentation = None
...
class organisationIdentificationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 10, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.ech.ch/xmlns/eCH-0097/2}uid uses Python identifier uid
    __uid = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'uid'), 'uid', '__httpwww_ech_chxmlnseCH_00972_organisationIdentificationType_httpwww_ech_chxmlnseCH_00972uid', False, pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 12, 3), )
    ...
    __localOrganisationId = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'localOrganisationId'), 'localOrganisationId', '__httpwww_ech_chxmlnseCH_00972_organisationIdentificationType_httpwww_ech_chxmlnseCH_00972localOrganisationId', False, pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 13, 3), )
    ...
    __OtherOrganisationId = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'OtherOrganisationId'), 'OtherOrganisationId', '__httpwww_ech_chxmlnseCH_00972_organisationIdentificationType_httpwww_ech_chxmlnseCH_00972OtherOrganisationId', True, pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 14, 3), )
    ...
    __legalForm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'legalForm'), 'legalForm', '__httpwww_ech_chxmlnseCH_00972_organisationIdentificationType_httpwww_ech_chxmlnseCH_00972legalForm', False, pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 18, 3), )
...
class namedOrganisationIdType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.ech.ch/xmlns/eCH-0097/2}organisationIdCategory uses Python identifier organisationIdCategory
    __organisationIdCategory = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'organisationIdCategory'), 'organisationIdCategory', '__httpwww_ech_chxmlnseCH_00972_namedOrganisationIdType_httpwww_ech_chxmlnseCH_00972organisationIdCategory', False, pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 23, 3), )
    ...
    __organisationId = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'organisationId'), 'organisationId', '__httpwww_ech_chxmlnseCH_00972_namedOrganisationIdType_httpwww_ech_chxmlnseCH_00972organisationId', False, pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 30, 3), )
...
organisationIdentificationRoot = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'organisationIdentificationRoot'), CTD_ANON, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 75, 1))
Namespace.addCategoryObject('elementBinding', organisationIdentificationRoot.name().localName(), organisationIdentificationRoot)



organisationIdentificationType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'uid'), uidStructureType, scope=organisationIdentificationType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 12, 3)))

organisationIdentificationType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'localOrganisationId'), namedOrganisationIdType, scope=organisationIdentificationType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 13, 3)))

organisationIdentificationType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'OtherOrganisationId'), namedOrganisationIdType, scope=organisationIdentificationType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 14, 3)))

organisationIdentificationType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'organisationName'), organisationNameType, scope=organisationIdentificationType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 15, 3)))

organisationIdentificationType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'organisationLegalName'), organisationNameType, scope=organisationIdentificationType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 16, 3)))

organisationIdentificationType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'organisationAdditionalName'), organisationNameType, scope=organisationIdentificationType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 17, 3)))

organisationIdentificationType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'legalForm'), legalFormType, scope=organisationIdentificationType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 18, 3)))
...
def _BuildAutomaton ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 12, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 14, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 16, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 17, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 18, 3))
    counters.add(cc_4)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(organisationIdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'uid')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 12, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(organisationIdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'localOrganisationId')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 13, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(organisationIdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'OtherOrganisationId')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 14, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(organisationIdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'organisationName')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 15, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(organisationIdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'organisationLegalName')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 16, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(organisationIdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'organisationAdditionalName')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 17, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(organisationIdentificationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'legalForm')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 18, 3))
...
namedOrganisationIdType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'organisationIdCategory'), STD_ANON_, scope=namedOrganisationIdType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 23, 3)))

namedOrganisationIdType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'organisationId'), STD_ANON, scope=namedOrganisationIdType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 30, 3)))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(namedOrganisationIdType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'organisationIdCategory')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 23, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(namedOrganisationIdType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'organisationId')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 30, 3))
...
uidStructureType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'uidOrganisationIdCategorie'), uidOrganisationIdCategorieType, scope=uidStructureType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 42, 3)))

uidStructureType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'uidOrganisationId'), uidOrganisationIdType, scope=uidStructureType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 43, 3)))
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(uidStructureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'uidOrganisationIdCategorie')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 42, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(uidStructureType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'uidOrganisationId')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 43, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'organisationIdentification'), organisationIdentificationType, scope=CTD_ANON, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 78, 4)))
...
def _BuildAutomaton_3 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'organisationIdentification')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0097_2_0.xsd', 78, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
