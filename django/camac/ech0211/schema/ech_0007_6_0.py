# ../../camac/ech0211/schema/ech_0007_6_0.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:16f67f23faf89ba4c924048d1e0b954b58272b13
# Generated 2022-03-31 09:05:47.006584 by PyXB version 1.2.6 using Python 3.8.12.final.0
...
class municipalityIdType (pyxb.binding.datatypes.int):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 5, 1)
    _Documentation = None
municipalityIdType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value=pyxb.binding.datatypes.int(9999), value_datatype=municipalityIdType)
municipalityIdType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value=pyxb.binding.datatypes.int(1), value_datatype=municipalityIdType)
municipalityIdType._CF_totalDigits = pyxb.binding.facets.CF_totalDigits(value=pyxb.binding.datatypes.positiveInteger(4))
municipalityIdType._InitializeFacetMap(municipalityIdType._CF_maxInclusive,
...
class municipalityNameType (pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 12, 1)
    _Documentation = None
...
class cantonFlAbbreviationType (pyxb.binding.datatypes.token, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 17, 1)
    _Documentation = None
cantonFlAbbreviationType._CF_enumeration = pyxb.binding.facets.CF_enumeration(enum_prefix=None, value_datatype=cantonFlAbbreviationType)
...
cantonFlAbbreviationType._InitializeFacetMap(cantonFlAbbreviationType._CF_enumeration,
   cantonFlAbbreviationType._CF_maxLength)
...
class cantonAbbreviationType (pyxb.binding.datatypes.token, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 49, 1)
    _Documentation = None
cantonAbbreviationType._CF_enumeration = pyxb.binding.facets.CF_enumeration(enum_prefix=None, value_datatype=cantonAbbreviationType)
...
cantonAbbreviationType._InitializeFacetMap(cantonAbbreviationType._CF_enumeration,
   cantonAbbreviationType._CF_maxLength)
...
class historyMunicipalityId (pyxb.binding.datatypes.int):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 80, 1)
    _Documentation = None
historyMunicipalityId._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(value=pyxb.binding.datatypes.int(99999), value_datatype=historyMunicipalityId)
historyMunicipalityId._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value=pyxb.binding.datatypes.int(10001), value_datatype=historyMunicipalityId)
historyMunicipalityId._InitializeFacetMap(historyMunicipalityId._CF_maxInclusive,
   historyMunicipalityId._CF_minInclusive)
...
class swissMunicipalityType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 86, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.ech.ch/xmlns/eCH-0007/6}municipalityId uses Python identifier municipalityId
    __municipalityId = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'municipalityId'), 'municipalityId', '__httpwww_ech_chxmlnseCH_00076_swissMunicipalityType_httpwww_ech_chxmlnseCH_00076municipalityId', False, pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 88, 3), )
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 103, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.ech.ch/xmlns/eCH-0007/6}swissMunicipality uses Python identifier swissMunicipality
    __swissMunicipality = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'swissMunicipality'), 'swissMunicipality', '__httpwww_ech_chxmlnseCH_00076_CTD_ANON_httpwww_ech_chxmlnseCH_00076swissMunicipality', False, pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 105, 4), )
    ...
    __swissAndFlMunicipality = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'swissAndFlMunicipality'), 'swissAndFlMunicipality', '__httpwww_ech_chxmlnseCH_00076_CTD_ANON_httpwww_ech_chxmlnseCH_00076swissAndFlMunicipality', False, pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 106, 4), )
...
municipalityRoot = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'municipalityRoot'), CTD_ANON, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 102, 1))
Namespace.addCategoryObject('elementBinding', municipalityRoot.name().localName(), municipalityRoot)



swissMunicipalityType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'municipalityId'), municipalityIdType, scope=swissMunicipalityType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 88, 3)))

swissMunicipalityType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'municipalityName'), municipalityNameType, scope=swissMunicipalityType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 89, 3)))

swissMunicipalityType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cantonAbbreviation'), cantonAbbreviationType, scope=swissMunicipalityType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 90, 3)))

swissMunicipalityType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'historyMunicipalityId'), historyMunicipalityId, scope=swissMunicipalityType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 91, 3)))
...
def _BuildAutomaton ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 88, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 90, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 91, 3))
    counters.add(cc_2)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(swissMunicipalityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'municipalityId')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(swissMunicipalityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'municipalityName')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 89, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(swissMunicipalityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cantonAbbreviation')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 90, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(swissMunicipalityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'historyMunicipalityId')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 91, 3))
...
swissAndFlMunicipalityType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'municipalityId'), municipalityIdType, scope=swissAndFlMunicipalityType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 96, 3)))

swissAndFlMunicipalityType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'municipalityName'), municipalityNameType, scope=swissAndFlMunicipalityType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 97, 3)))

swissAndFlMunicipalityType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cantonFlAbbreviation'), cantonFlAbbreviationType, scope=swissAndFlMunicipalityType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 98, 3)))

swissAndFlMunicipalityType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'historyMunicipalityId'), historyMunicipalityId, scope=swissAndFlMunicipalityType, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 99, 3)))
...
def _BuildAutomaton_ ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 99, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(swissAndFlMunicipalityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'municipalityId')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 96, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(swissAndFlMunicipalityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'municipalityName')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 97, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(swissAndFlMunicipalityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cantonFlAbbreviation')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 98, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(swissAndFlMunicipalityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'historyMunicipalityId')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 99, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'swissMunicipality'), swissMunicipalityType, scope=CTD_ANON, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 105, 4)))

CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'swissAndFlMunicipality'), swissAndFlMunicipalityType, scope=CTD_ANON, location=pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 106, 4)))
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'swissMunicipality')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 105, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'swissAndFlMunicipality')), pyxb.utils.utility.Location('/app/camac/ech0211/xsd/ech_0007_6_0.xsd', 106, 4))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    st_0._set_transitionSet(transitions)
