...
CONSTRAINT WORKFLOW_ACTION_PK PRIMARY KEY ( ACTION_ID)
) 
LOGGING 
TABLESPACE SYSTEM 
PCTFREE 10 
...
NOCOMPRESSCREATE UNIQUE INDEX WORKFLOW_ACTION_INDEX1 ON WORKFLOW_ACTION (ACTION_ID ASC, WORKFLOW_ID ASC) ;

CREATE UNIQUE INDEX WORKFLOW_ACTION_INDEX1 ON WORKFLOW_ACTION (ACTION_ID ASC, WORKFLOW_ID ASC) ;

alter table "CAMAC_DEV"."WORKFLOW_ACTION" drop column "WORKFLOW_ACTION_ID"
