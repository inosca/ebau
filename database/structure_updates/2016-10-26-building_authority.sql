...
CREATE SEQUENCE BUILDING_AUTHORITY_SECTION_SEQ;

CREATE TRIGGER BUILDING_AUTHORITY_SECTION_TRG
BEFORE INSERT ON BUILDING_AUTHORITY_SECTION
FOR EACH ROW
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.BUILDING_AUTHORITY_SECTION_ID IS NULL THEN
      SELECT BUILDING_AUTHORITY_SECTION_SEQ.NEXTVAL INTO :NEW.BUILDING_AUTHORITY_SECTION_ID FROM SYS.DUAL;
    END IF;
...
ALTER TABLE BUILDING_AUTHORITY_COMMENT
ADD CONSTRAINT BUILDING_AUTHORITY_COMMEN_FK2 FOREIGN KEY (
  INSTANCE_ID
)
REFERENCES INSTANCE (
  INSTANCE_ID
...
CREATE SEQUENCE BUILDING_AUTHORITY_COMMEN_SEQ;

CREATE TRIGGER BUILDING_AUTHORITY_COMMEN_TRG
BEFORE INSERT ON BUILDING_AUTHORITY_COMMENT
FOR EACH ROW
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.BUILDING_AUTHORITY_COMMENT_ID IS NULL THEN
      SELECT BUILDING_AUTHORITY_COMMEN_SEQ.NEXTVAL INTO :NEW.BUILDING_AUTHORITY_COMMENT_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
ALTER TABLE BUILDING_AUTHORITY_SECTION_DIS
ADD CONSTRAINT BA_SECTION_DIS_FK2 FOREIGN KEY (
  BA_SECTION_ID
)
REFERENCES BUILDING_AUTHORITY_SECTION (
  BUILDING_AUTHORITY_SECTION_ID
...
CREATE SEQUENCE BA_SECTION_DIS_SEQ;

CREATE TRIGGER BA_SECTION_DIS_TRG
BEFORE INSERT ON BUILDING_AUTHORITY_SECTION_DIS
FOR EACH ROW
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.BA_SECTION_DIS_ID IS NULL THEN
      SELECT BA_SECTION_DIS_SEQ.NEXTVAL INTO :NEW.BA_SECTION_DIS_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
CREATE SEQUENCE BA_ITEM_DIS_SEQ;

CREATE TRIGGER BA_ITEM_DIS_TRG
BEFORE INSERT ON BUILDING_AUTHORITY_ITEM_DIS
FOR EACH ROW
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.BA_ITEM_DIS_ID IS NULL THEN
      SELECT BA_ITEM_DIS_SEQ.NEXTVAL INTO :NEW.BA_ITEM_DIS_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
CREATE SEQUENCE BUILDING_AUTHORITY_BUTTON_SEQ;

CREATE TRIGGER BUILDING_AUTHORITY_BUTTON_TRG
BEFORE INSERT ON BUILDING_AUTHORITY_BUTTON
FOR EACH ROW
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.BUILDING_AUTHORITY_BUTTON_ID IS NULL THEN
      SELECT BUILDING_AUTHORITY_BUTTON_SEQ.NEXTVAL INTO :NEW.BUILDING_AUTHORITY_BUTTON_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
CREATE SEQUENCE BA_BUTTONSTATE_SEQ;

CREATE TRIGGER BA_BUTTONSTATE_TRG
BEFORE INSERT ON BUILDING_AUTHORITY_BUTTONSTATE
FOR EACH ROW
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.BA_BUTTON_STATE_ID IS NULL THEN
      SELECT BA_BUTTONSTATE_SEQ.NEXTVAL INTO :NEW.BA_BUTTON_STATE_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
CREATE SEQUENCE BUILDING_AUTHORITY_EMAIL_SEQ;

CREATE TRIGGER BUILDING_AUTHORITY_EMAIL_TRG
BEFORE INSERT ON BUILDING_AUTHORITY_EMAIL
FOR EACH ROW
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.BUILDING_AUTHORITY_EMAIL_ID IS NULL THEN
      SELECT BUILDING_AUTHORITY_EMAIL_SEQ.NEXTVAL INTO :NEW.BUILDING_AUTHORITY_EMAIL_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
CREATE SEQUENCE BUILDING_AUTHORITY_DOC_SEQ;

CREATE TRIGGER BUILDING_AUTHORITY_DOC_TRG
BEFORE INSERT ON BUILDING_AUTHORITY_DOC
FOR EACH ROW
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.BUILDING_AUTHORITY_DOC_ID IS NULL THEN
      SELECT BUILDING_AUTHORITY_DOC_SEQ.NEXTVAL INTO :NEW.BUILDING_AUTHORITY_DOC_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
