                    ...
                    <#if realm.password && realm.loginWithEmailAllowed>
                        <form class="sign-in-form" id="kc-form-login" onsubmit="login.disabled = true; return true;"
                            ...
                            <div class="login-helpertext">
                                <p> <span class="german-text">Anmeldung mit E-Mail:</span>/<span class="french-text">Se connecter avec l'email :</span>
                                </p>
                            </div>
                            <div class="login-helpertext-mobile">
                                <p class="divider">
                                    <span class="german-text"> oder mit E-Mail </span>/<span class="french-text">ou par courriel</span>
                                </p>
                            </div>
                            ...
                            <div class="passwordField">
                                <input type="password" name="password" id="password" tabindex="2" autocomplete="off" placeholder="Passwort / Mot de passe" /><br />
                                ...
                                <#if !realm.loginWithEmailAllowed>
                                    ...
                                    <#else>
                                        <div class="one-click-login">
                                            <div class="login-helpertext">
                                                <p class="divider">
                                                    <span class="german-text"> oder </span>/<span class="french-text">ou</span>
                                                </p>
                                            </div>
                                            <div class="login-helpertext-mobile first-helpertext">
                                                <p> <span class="german-text"> Melden Sie sich an: </span>/<span class="french-text"> Inscrivez-vous :</span>
                                                </p>
                                            </div>
                                            <#-- IdPs -->
                                                <#list socialProviders as p>
