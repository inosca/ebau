...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#elseif section = "socialProviders" >
        <#if realm.password && social?? && social.providers?has_content>
            <div id="kc-social-providers" class="${properties.kcFormSocialAccountSectionClass!} uk-width-medium">
                <#list social.providers as p>
                    <a id="social-${p.alias}" class="uk-card-default uk-padding uk-flex uk-flex-middle" type="button" href="${p.loginUrl}">
                        <img src="${url.resourcesPath}/img/wappen-kanton-so.svg" class="uk-margin-right" style="width: 40px">
