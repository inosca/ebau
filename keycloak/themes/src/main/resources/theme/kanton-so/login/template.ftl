...
<body class="${properties.kcBodyClass!}" data-page-id="login-${pageId}">
    <div class="${properties.kcLoginClass!}">
        ...
        <div class="${properties.kcFormCardClass!}">
            <#-- CHANGE: add grid layout to login page-->
            <div class="uk-grid">
                <div class="uk-card-default uk-padding uk-width-expand">
                    ...
                    <div id="kc-content">
                        <div id="kc-content-wrapper">
                            ...
                            <#if displayMessage && message?has_content && (message.type != 'warning' || !isAppInitiatedAction??)>
                                <div class="alert-${message.type} ${properties.kcAlertClass!} uk-alert uk-alert-<#if message.type = 'error'>danger<#else>${message.type}</#if>">
                ...
                <#-- CHANGE: place socialProviders in grid layout -->
