...
<@layout.mainLayout active='account' bodyClass='user'; section>
    ...
    <form action="${url.accountUrl}" class="form-horizontal" method="post">
        ...
        <div class="form-group ${messagesPerField.printIfExists('email','has-error')}">
            <div class="uk-margin">
                <label for="email" class="uk-form-label">${msg("email")}</label> <span class="required">*</span>
        ...
        <div class="form-group ${messagesPerField.printIfExists('firstName','has-error')}">
            <div class="uk-margin">
                <label for="firstName" class="uk-form-label">${msg("firstName")}</label> <span class="required">*</span>
        ...
        <div class="form-group ${messagesPerField.printIfExists('lastName','has-error')}">
            <div class="uk-margin">
                <label for="lastName" class="uk-form-label">${msg("lastName")}</label> <span class="required">*</span>
