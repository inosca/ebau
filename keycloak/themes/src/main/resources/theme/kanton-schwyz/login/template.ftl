...
<#-- Custom: add "isLogin" attribute (see below for details) -->
<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true displayRequiredFields=false isLogin=false displayWide=false showAnotherWayIfPresent=true>
  ...
  <div class="${properties.kcLoginClass!}">
    <div id="kc-header" class="${properties.kcHeaderClass!}">
      <div id="kc-header-wrapper" class="${properties.kcHeaderWrapperClass!}">
        <#-- Custom: Replace realm name with header logo -->
    ...
    <#-- Custom: remove generic loginFooter -->
    <#-- <@loginFooter.content/> -->
    </div>
  </div>
</body>
